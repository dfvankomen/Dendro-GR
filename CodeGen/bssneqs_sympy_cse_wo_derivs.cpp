...
const double DENDRO_440 =
    ...
    DENDRO_375 * grad_1_Gt2 + 4 * grad_1_Gt1 * gt3[pp];
...
const double DENDRO_628 =
    ...
    DENDRO_531 * grad_2_Gt2 + DENDRO_533 * grad_1_Gt2 + DENDRO_535 * gt1[pp] +
    DENDRO_537 * gt3[pp] - DENDRO_540 * grad_1_chi;
...
const double DENDRO_870 =
    beta0[pp] * grad_0_Gt0 + beta1[pp] * grad_1_Gt0 + beta2[pp] * grad_2_Gt0;
...
const double DENDRO_885 =
    beta0[pp] * grad_0_Gt2 + beta1[pp] * grad_1_Gt2 + beta2[pp] * grad_2_Gt2;
...
a_rhs[pp] = -DENDRO_0 * K[pp] +
            lambda[0] * (beta0[pp] * grad_0_alpha + beta1[pp] * grad_1_alpha +
...
gt_rhs00[pp] = -At0[pp] * DENDRO_0 + DENDRO_2 * gt0[pp] +
               DENDRO_3 * grad_0_beta1 + DENDRO_4 * grad_0_beta2 -
               DENDRO_5 * grad_1_beta1 - DENDRO_5 * grad_2_beta2 +
               beta0[pp] * grad_0_gt0 + beta1[pp] * grad_1_gt0 +
               beta2[pp] * grad_2_gt0;
//--
gt_rhs01[pp] =
    -At1[pp] * DENDRO_0 + DENDRO_6 * grad_0_beta0 + DENDRO_6 * grad_1_beta1 -
    DENDRO_7 * gt1[pp] + beta0[pp] * grad_0_gt1 + beta1[pp] * grad_1_gt1 +
    beta2[pp] * grad_2_gt1 + grad_0_beta1 * gt3[pp] + grad_0_beta2 * gt4[pp] +
    grad_1_beta0 * gt0[pp] + grad_1_beta2 * gt2[pp];
//--
gt_rhs02[pp] =
    -At2[pp] * DENDRO_0 + DENDRO_8 * grad_0_beta0 + DENDRO_8 * grad_2_beta2 -
    DENDRO_9 * gt2[pp] + beta0[pp] * grad_0_gt2 + beta1[pp] * grad_1_gt2 +
    beta2[pp] * grad_2_gt2 + grad_0_beta1 * gt4[pp] + grad_0_beta2 * gt5[pp] +
    grad_2_beta0 * gt0[pp] + grad_2_beta1 * gt1[pp];
//--
gt_rhs11[pp] = -At3[pp] * DENDRO_0 - DENDRO_10 * gt3[pp] + DENDRO_11 * gt3[pp] +
               DENDRO_12 * grad_1_beta2 + DENDRO_3 * grad_1_beta0 -
               DENDRO_7 * gt3[pp] + beta0[pp] * grad_0_gt3 +
               beta1[pp] * grad_1_gt3 + beta2[pp] * grad_2_gt3;
//--
gt_rhs12[pp] =
    -At4[pp] * DENDRO_0 - DENDRO_10 * gt4[pp] + DENDRO_13 * grad_1_beta1 +
    DENDRO_13 * grad_2_beta2 + beta0[pp] * grad_0_gt4 + beta1[pp] * grad_1_gt4 +
    beta2[pp] * grad_2_gt4 + grad_1_beta0 * gt2[pp] + grad_1_beta2 * gt5[pp] +
    grad_2_beta0 * gt1[pp] + grad_2_beta1 * gt3[pp];
//--
gt_rhs22[pp] =
    -At5[pp] * DENDRO_0 - DENDRO_10 * gt5[pp] + DENDRO_12 * grad_2_beta1 +
    DENDRO_14 * gt5[pp] + DENDRO_4 * grad_2_beta0 - DENDRO_9 * gt5[pp] +
    beta0[pp] * grad_0_gt5 + beta1[pp] * grad_1_gt5 + beta2[pp] * grad_2_gt5;
//--
...
At_rhs00[pp] =
    ...
    beta0[pp] * grad_0_At0 + beta1[pp] * grad_1_At0 + beta2[pp] * grad_2_At0;
//--
At_rhs01[pp] =
    At0[pp] * grad_1_beta0 - At1[pp] * DENDRO_7 + At2[pp] * grad_1_beta2 +
    At3[pp] * grad_0_beta1 + At4[pp] * grad_0_beta2 +
    DENDRO_721 *
        (DENDRO_305 *
...
//--
At_rhs02[pp] =
    At0[pp] * grad_2_beta0 + At1[pp] * grad_2_beta1 - At2[pp] * DENDRO_9 +
    At4[pp] * grad_0_beta1 + At5[pp] * grad_0_beta2 +
    DENDRO_721 *
        (DENDRO_305 *
...
At_rhs11[pp] =
    ...
    beta0[pp] * grad_0_At3 + beta1[pp] * grad_1_At3 + beta2[pp] * grad_2_At3;
//--
At_rhs12[pp] =
    At1[pp] * grad_2_beta0 + At2[pp] * grad_1_beta0 + At3[pp] * grad_2_beta1 -
    At4[pp] * DENDRO_10 + At5[pp] * grad_1_beta2 +
    DENDRO_721 *
        (DENDRO_305 *
    ...
    beta0[pp] * grad_0_At4 + beta1[pp] * grad_1_At4 + beta2[pp] * grad_2_At4;
//--
At_rhs22[pp] =
    ...
    beta0[pp] * grad_0_At5 + beta1[pp] * grad_1_At5 + beta2[pp] * grad_2_At5;
//--
K_rhs[pp] =
    -DENDRO_288 * chi[pp] *
...
//--
B_rhs0[pp]  = -B0[pp] * eta - DENDRO_870 * lambda[3] + DENDRO_871 +
             lambda[2] * (beta0[pp] * grad_0_B0 + beta1[pp] * grad_1_B0 +
                          beta2[pp] * grad_2_B0);
//--
B_rhs1[pp] = -B1[pp] * eta + DENDRO_112 * DENDRO_867 + DENDRO_202 * DENDRO_868 +
             ...
             lambda[2] * (beta0[pp] * grad_0_B1 + beta1[pp] * grad_1_B1 +
                          beta2[pp] * grad_2_B1);
//--
B_rhs2[pp] = -B2[pp] * eta - DENDRO_885 * lambda[3] + DENDRO_886 +
