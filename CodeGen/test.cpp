...
if (blk->m_bflag != 0) {
    radiative_bc_pt<pw, nx>(&chi_rhs[gidx], chi[gidx], grad_0_chi, grad_1_chi,
                            grad_2_chi, 1.0, 1.0, blk);
}
...
if (blk->m_bflag != 0) {
    radiative_bc_pt<pw, nx>(&gt_rhs00[gidx], gt0[gidx], grad_0_gt0, grad_1_gt0,
                            grad_2_gt0, 1.0, 1.0, blk);
    radiative_bc_pt<pw, nx>(&gt_rhs01[gidx], gt1[gidx], grad_0_gt1, grad_1_gt1,
                            grad_2_gt1, 1.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&gt_rhs02[gidx], gt2[gidx], grad_0_gt2, grad_1_gt2,
                            grad_2_gt2, 1.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&gt_rhs11[gidx], gt3[gidx], grad_0_gt3, grad_1_gt3,
                            grad_2_gt3, 1.0, 1.0, blk);
    radiative_bc_pt<pw, nx>(&gt_rhs12[gidx], gt4[gidx], grad_0_gt4, grad_1_gt4,
                            grad_2_gt4, 1.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&gt_rhs22[gidx], gt5[gidx], grad_0_gt5, grad_1_gt5,
                            grad_2_gt5, 1.0, 1.0, blk);
}
...
if (blk->m_bflag != 0) {
    radiative_bc_pt<pw, nx>(&K_rhs[gidx], K[gidx], grad_0_K, grad_1_K, grad_2_K,
                            1.0, 0.0, blk);
}
...
if (blk->m_bflag != 0) {
    radiative_bc_pt<pw, nx>(&Gt_rhs0[gidx], Gt0[gidx], grad_0_Gt0, grad_1_Gt0,
                            grad_2_Gt0, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&Gt_rhs1[gidx], Gt1[gidx], grad_0_Gt1, grad_1_Gt1,
                            grad_2_Gt1, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&Gt_rhs2[gidx], Gt2[gidx], grad_0_Gt2, grad_1_Gt2,
                            grad_2_Gt2, 2.0, 0.0, blk);
}
...
if (blk->m_bflag != 0) {
    radiative_bc_pt<pw, nx>(&At_rhs00[gidx], At0[gidx], grad_0_At0, grad_1_At0,
                            grad_2_At0, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&At_rhs01[gidx], At1[gidx], grad_0_At1, grad_1_At1,
                            grad_2_At1, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&At_rhs02[gidx], At2[gidx], grad_0_At2, grad_1_At2,
                            grad_2_At2, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&At_rhs11[gidx], At3[gidx], grad_0_At3, grad_1_At3,
                            grad_2_At3, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&At_rhs12[gidx], At4[gidx], grad_0_At4, grad_1_At4,
                            grad_2_At4, 2.0, 0.0, blk);
    radiative_bc_pt<pw, nx>(&At_rhs22[gidx], At5[gidx], grad_0_At5, grad_1_At5,
                            grad_2_At5, 2.0, 0.0, blk);
}
