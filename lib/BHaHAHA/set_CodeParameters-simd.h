...
const REAL NOSIMDdxx0 = params->dxx0;                                        // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx0
...
const REAL NOSIMDdxx1 = params->dxx1;                                        // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx1
...
const REAL NOSIMDdxx2 = params->dxx2;                                        // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx2
...
const REAL NOSIMDeta_damping = commondata->eta_damping;                      // nrpydev.infrastructures.BHaH.BHaHAHA.rhs_eval_KO_apply::eta_damping
...
const REAL NOSIMDinterp_src_dxx0 = commondata->interp_src_dxx0; // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__interp_src_set_up::interp_src_dxx0
...
const REAL NOSIMDinterp_src_dxx1 = commondata->interp_src_dxx1; // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__interp_src_set_up::interp_src_dxx1
...
const REAL NOSIMDinterp_src_dxx2 = commondata->interp_src_dxx2; // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__interp_src_set_up::interp_src_dxx2
...
const REAL NOSIMDinvdxx0 = params->invdxx0;    // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::invdxx0
...
const REAL NOSIMDinvdxx1 = params->invdxx1;                            // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::invdxx1
...
const REAL NOSIMDinvdxx2 = params->invdxx2;                            // nrpydev.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::invdxx2
...
const REAL NOSIMDKO_diss_strength = commondata->KO_diss_strength;      // nrpydev.infrastructures.BHaH.BHaHAHA.rhs_eval_KO_apply::KO_diss_strength
