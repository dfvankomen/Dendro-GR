...
void readParamJSONFile(const char* fName, MPI_Comm comm) {
    ...
    if (parFile.find("BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT") != parFile.end())
        bssn::BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT =
            parFile["BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT"];
    if (parFile.find("BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT") != parFile.end())
        bssn::BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT =
            parFile["BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT"];
    if (parFile.find("BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT") != parFile.end())
        bssn::BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT =
            parFile["BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT"];
    if (parFile.find("BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT") != parFile.end())
        bssn::BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT =
            parFile["BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT"];
...
void dumpParamFile(std::ostream& sout, int root, MPI_Comm comm) {
    ...
    if (rank == root) {
        ...
        sout << YLW << "\tBSSN_WAVELET_TOL :" << bssn::BSSN_WAVELET_TOL << NRM
             << std::endl;
        sout << YLW << "\tBSSN_WEIGHT_1_DERIV_FIRST_WEIGHT :"
             << bssn::BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT << NRM << std::endl;
        sout << YLW << "\tBSSN_WEIGHT_1_DERIV_SECOND_WEIGHT :"
             << bssn::BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT << NRM << std::endl;
        sout << YLW << "\tBSSN_WEIGHT_2_DERIV_FIRST_WEIGHT :"
             << bssn::BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT << NRM << std::endl;
        sout << YLW << "\tBSSN_WEIGHT_2_DERIV_SECOND_WEIGHT :"
             << bssn::BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT << NRM << std::endl;
        ...
        if (bssn::BSSN_ID_TYPE == 7 || bssn::BSSN_ID_TYPE == 9 ||
            ...
            switch (TEUK_ID_FUNCTIONAL_FORM) {
                case 0:
                    sout << "Ck Polynomial of order " << TEUK_KK << std::endl;
                    break;
                case 1:
