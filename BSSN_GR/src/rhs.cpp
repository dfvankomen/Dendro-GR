...
void bssnRHS(double **uzipVarsRHS, const double **uZipVars,
    ...
    bssn::GLOBAL_RK_STEP_COUNTER++;
#endif
}

std::ofstream prepare_file(std::string filename, const unsigned int blockid,
                           const unsigned int *sz, const double *pmin,
                           const double *pmax, const unsigned int bflag,
                           const double hx, const double hy, const double hz,
                           const unsigned int num_vars,
                           const unsigned int num_grad,
                           const unsigned int num_rhs) {
    std::ofstream file(filename, std::ios::binary | std::ios::out);

    // get the global step ID
    file.write((char *)&bssn::GLOBAL_STEP_COUNTER, sizeof(GLOBAL_STEP_COUNTER));
    file.write((char *)&bssn::GLOBAL_RK_STEP_COUNTER,
               sizeof(GLOBAL_RK_STEP_COUNTER));
    file.write((char *)&blockid, sizeof(blockid));
    file.write((char *)&num_vars, sizeof(num_vars));
    file.write((char *)&num_grad, sizeof(num_grad));
    file.write((char *)&num_rhs, sizeof(num_rhs));

    // the boundary flag is also super important
    file.write((char *)&bflag, sizeof(bflag));
    file.write((char *)&bssn::BSSN_PADDING_WIDTH,
               sizeof(bssn::BSSN_PADDING_WIDTH));

    // now we need to save the size!
    file.write((char *)sz, sizeof(unsigned int) * 3);
    file.write((char *)pmin, sizeof(double) * 3);
    file.write((char *)pmax, sizeof(double) * 3);
    file.write((char *)&hx, sizeof(hx));
    file.write((char *)&hy, sizeof(hy));
    file.write((char *)&hz, sizeof(hz));
...
void bssnrhs(double **unzipVarsRHS, const double **uZipVars,
    ...
    // PREPARE FILE FOR BUFFER DUMPING
    ...
    char buf[5];
    sprintf(buf, "%04d", GLOBAL_STEP_COUNTER);
    std::string filename = "_blkdump_step" + std::string(buf) + "_rk";
    sprintf(buf, "%04d", GLOBAL_RK_STEP_COUNTER);
    filename += std::string(buf) + "_blk";
    sprintf(buf, "%04d", blockid);
    filename += std::string(buf) + "_rank";
    sprintf(buf, "%04d", rank);
    filename += std::string(buf) + ".bin";
    bool save_grad = true;
    if (GLOBAL_RK_STEP_COUNTER == 0 &&
        (GLOBAL_STEP_COUNTER % bssn::BSSN_IO_OUTPUT_FREQ == 0)) {
        file = prepare_file(bssn::BSSN_VTU_FILE_PREFIX + filename, blockid, sz,
                            pmin, pmax, bflag, hx, hy, hz, bssn::BSSN_NUM_VARS,
                            save_grad ? 138 : 0, bssn::BSSN_NUM_VARS);
    }
    ...
    if (GLOBAL_RK_STEP_COUNTER == 0 &&
        (GLOBAL_STEP_COUNTER % bssn::BSSN_IO_OUTPUT_FREQ == 0)) {
        file.write((char *)alpha, sizeof(double) * n);
        file.write((char *)chi, sizeof(double) * n);
        file.write((char *)K, sizeof(double) * n);
        file.write((char *)gt0, sizeof(double) * n);
        file.write((char *)gt1, sizeof(double) * n);
        file.write((char *)gt2, sizeof(double) * n);
        file.write((char *)gt3, sizeof(double) * n);
        file.write((char *)gt4, sizeof(double) * n);
        file.write((char *)gt5, sizeof(double) * n);
        file.write((char *)beta0, sizeof(double) * n);
        file.write((char *)beta1, sizeof(double) * n);
        file.write((char *)beta2, sizeof(double) * n);
        file.write((char *)At0, sizeof(double) * n);
        file.write((char *)At1, sizeof(double) * n);
        file.write((char *)At2, sizeof(double) * n);
        file.write((char *)At3, sizeof(double) * n);
        file.write((char *)At4, sizeof(double) * n);
        file.write((char *)At5, sizeof(double) * n);
        file.write((char *)Gt0, sizeof(double) * n);
        file.write((char *)Gt1, sizeof(double) * n);
        file.write((char *)Gt2, sizeof(double) * n);
        file.write((char *)B0, sizeof(double) * n);
        file.write((char *)B1, sizeof(double) * n);
        file.write((char *)B2, sizeof(double) * n);
    }
    ...
    // then dump the derivatives
    if (GLOBAL_RK_STEP_COUNTER == 0 &&
        (GLOBAL_STEP_COUNTER % bssn::BSSN_IO_OUTPUT_FREQ == 0)) {
        file.write((char *)grad_0_alpha, sizeof(double) * n);
        file.write((char *)grad_1_alpha, sizeof(double) * n);
        file.write((char *)grad_2_alpha, sizeof(double) * n);
        file.write((char *)grad_0_beta0, sizeof(double) * n);
        file.write((char *)grad_1_beta0, sizeof(double) * n);
        file.write((char *)grad_2_beta0, sizeof(double) * n);
        file.write((char *)grad_0_beta1, sizeof(double) * n);
        file.write((char *)grad_1_beta1, sizeof(double) * n);
        file.write((char *)grad_2_beta1, sizeof(double) * n);
        file.write((char *)grad_0_beta2, sizeof(double) * n);
        file.write((char *)grad_1_beta2, sizeof(double) * n);
        file.write((char *)grad_2_beta2, sizeof(double) * n);
        file.write((char *)grad_0_B0, sizeof(double) * n);
        file.write((char *)grad_1_B0, sizeof(double) * n);
        file.write((char *)grad_2_B0, sizeof(double) * n);
        file.write((char *)grad_0_B1, sizeof(double) * n);
        file.write((char *)grad_1_B1, sizeof(double) * n);
        file.write((char *)grad_2_B1, sizeof(double) * n);
        file.write((char *)grad_0_B2, sizeof(double) * n);
        file.write((char *)grad_1_B2, sizeof(double) * n);
        file.write((char *)grad_2_B2, sizeof(double) * n);
        file.write((char *)grad_0_chi, sizeof(double) * n);
        file.write((char *)grad_1_chi, sizeof(double) * n);
        file.write((char *)grad_2_chi, sizeof(double) * n);
        file.write((char *)grad_0_Gt0, sizeof(double) * n);
        file.write((char *)grad_1_Gt0, sizeof(double) * n);
        file.write((char *)grad_2_Gt0, sizeof(double) * n);
        file.write((char *)grad_0_Gt1, sizeof(double) * n);
        file.write((char *)grad_1_Gt1, sizeof(double) * n);
        file.write((char *)grad_2_Gt1, sizeof(double) * n);
        file.write((char *)grad_0_Gt2, sizeof(double) * n);
        file.write((char *)grad_1_Gt2, sizeof(double) * n);
        file.write((char *)grad_2_Gt2, sizeof(double) * n);
        file.write((char *)grad_0_K, sizeof(double) * n);
        file.write((char *)grad_1_K, sizeof(double) * n);
        file.write((char *)grad_2_K, sizeof(double) * n);
        file.write((char *)grad_0_gt0, sizeof(double) * n);
        file.write((char *)grad_1_gt0, sizeof(double) * n);
        file.write((char *)grad_2_gt0, sizeof(double) * n);
        file.write((char *)grad_0_gt1, sizeof(double) * n);
        ...
        file.write((char *)grad_1_gt2, sizeof(double) * n);
        file.write((char *)grad_2_gt2, sizeof(double) * n);
        file.write((char *)grad_0_gt3, sizeof(double) * n);
        file.write((char *)grad_1_gt3, sizeof(double) * n);
        file.write((char *)grad_2_gt3, sizeof(double) * n);
        file.write((char *)grad_0_gt4, sizeof(double) * n);
        file.write((char *)grad_1_gt4, sizeof(double) * n);
        file.write((char *)grad_2_gt4, sizeof(double) * n);
        file.write((char *)grad_0_gt5, sizeof(double) * n);
        file.write((char *)grad_1_gt5, sizeof(double) * n);
        file.write((char *)grad_2_gt5, sizeof(double) * n);
        file.write((char *)grad_0_At0, sizeof(double) * n);
        file.write((char *)grad_1_At0, sizeof(double) * n);
        file.write((char *)grad_2_At0, sizeof(double) * n);
        file.write((char *)grad_0_At1, sizeof(double) * n);
        file.write((char *)grad_1_At1, sizeof(double) * n);
        file.write((char *)grad_2_At1, sizeof(double) * n);
        file.write((char *)grad_0_At2, sizeof(double) * n);
        file.write((char *)grad_1_At2, sizeof(double) * n);
        file.write((char *)grad_2_At2, sizeof(double) * n);
        file.write((char *)grad_0_At3, sizeof(double) * n);
        file.write((char *)grad_1_At3, sizeof(double) * n);
        file.write((char *)grad_2_At3, sizeof(double) * n);
        file.write((char *)grad_0_At4, sizeof(double) * n);
        file.write((char *)grad_1_At4, sizeof(double) * n);
        file.write((char *)grad_2_At4, sizeof(double) * n);
        file.write((char *)grad_0_At5, sizeof(double) * n);
        file.write((char *)grad_1_At5, sizeof(double) * n);
        file.write((char *)grad_2_At5, sizeof(double) * n);
        file.write((char *)grad2_0_0_gt0, sizeof(double) * n);
        file.write((char *)grad2_0_1_gt0, sizeof(double) * n);
        file.write((char *)grad2_0_2_gt0, sizeof(double) * n);
        file.write((char *)grad2_1_1_gt0, sizeof(double) * n);
        file.write((char *)grad2_1_2_gt0, sizeof(double) * n);
        file.write((char *)grad2_2_2_gt0, sizeof(double) * n);
        file.write((char *)grad2_0_0_gt1, sizeof(double) * n);
        file.write((char *)grad2_0_1_gt1, sizeof(double) * n);
        file.write((char *)grad2_0_2_gt1, sizeof(double) * n);
        file.write((char *)grad2_1_1_gt1, sizeof(double) * n);
        file.write((char *)grad2_1_2_gt1, sizeof(double) * n);
        file.write((char *)grad2_2_2_gt1, sizeof(double) * n);
        file.write((char *)grad2_0_0_gt2, sizeof(double) * n);
        file.write((char *)grad2_0_1_gt2, sizeof(double) * n);
        file.write((char *)grad2_0_2_gt2, sizeof(double) * n);
        file.write((char *)grad2_1_1_gt2, sizeof(double) * n);
        file.write((char *)grad2_1_2_gt2, sizeof(double) * n);
        file.write((char *)grad2_2_2_gt2, sizeof(double) * n);
        file.write((char *)grad2_0_0_gt3, sizeof(double) * n);
        file.write((char *)grad2_0_1_gt3, sizeof(double) * n);
        file.write((char *)grad2_0_2_gt3, sizeof(double) * n);
        file.write((char *)grad2_1_1_gt3, sizeof(double) * n);
        file.write((char *)grad2_1_2_gt3, sizeof(double) * n);
        file.write((char *)grad2_2_2_gt3, sizeof(double) * n);
        file.write((char *)grad2_0_0_gt4, sizeof(double) * n);
        file.write((char *)grad2_0_1_gt4, sizeof(double) * n);
        file.write((char *)grad2_0_2_gt4, sizeof(double) * n);
        file.write((char *)grad2_1_1_gt4, sizeof(double) * n);
        file.write((char *)grad2_1_2_gt4, sizeof(double) * n);
        file.write((char *)grad2_2_2_gt4, sizeof(double) * n);
        file.write((char *)grad2_0_0_gt5, sizeof(double) * n);
        file.write((char *)grad2_0_1_gt5, sizeof(double) * n);
        file.write((char *)grad2_0_2_gt5, sizeof(double) * n);
        file.write((char *)grad2_1_1_gt5, sizeof(double) * n);
        file.write((char *)grad2_1_2_gt5, sizeof(double) * n);
        file.write((char *)grad2_2_2_gt5, sizeof(double) * n);
        file.write((char *)grad2_0_0_chi, sizeof(double) * n);
        file.write((char *)grad2_0_1_chi, sizeof(double) * n);
        file.write((char *)grad2_0_2_chi, sizeof(double) * n);
        file.write((char *)grad2_1_1_chi, sizeof(double) * n);
        file.write((char *)grad2_1_2_chi, sizeof(double) * n);
        file.write((char *)grad2_2_2_chi, sizeof(double) * n);
        file.write((char *)grad2_0_0_alpha, sizeof(double) * n);
        file.write((char *)grad2_0_1_alpha, sizeof(double) * n);
        file.write((char *)grad2_0_2_alpha, sizeof(double) * n);
        file.write((char *)grad2_1_1_alpha, sizeof(double) * n);
        file.write((char *)grad2_1_2_alpha, sizeof(double) * n);
        file.write((char *)grad2_2_2_alpha, sizeof(double) * n);
        file.write((char *)grad2_0_0_beta0, sizeof(double) * n);
        file.write((char *)grad2_0_1_beta0, sizeof(double) * n);
        file.write((char *)grad2_0_2_beta0, sizeof(double) * n);
        file.write((char *)grad2_1_1_beta0, sizeof(double) * n);
        file.write((char *)grad2_1_2_beta0, sizeof(double) * n);
        file.write((char *)grad2_2_2_beta0, sizeof(double) * n);
        file.write((char *)grad2_0_0_beta1, sizeof(double) * n);
        file.write((char *)grad2_0_1_beta1, sizeof(double) * n);
        file.write((char *)grad2_0_2_beta1, sizeof(double) * n);
        file.write((char *)grad2_1_1_beta1, sizeof(double) * n);
        file.write((char *)grad2_1_2_beta1, sizeof(double) * n);
        file.write((char *)grad2_2_2_beta1, sizeof(double) * n);
        file.write((char *)grad2_0_0_beta2, sizeof(double) * n);
        file.write((char *)grad2_0_1_beta2, sizeof(double) * n);
        file.write((char *)grad2_0_2_beta2, sizeof(double) * n);
        file.write((char *)grad2_1_1_beta2, sizeof(double) * n);
        file.write((char *)grad2_1_2_beta2, sizeof(double) * n);
        file.write((char *)grad2_2_2_beta2, sizeof(double) * n);
    }
...
#pragma ivdep
    ...
    if (GLOBAL_RK_STEP_COUNTER == 0 &&
        (GLOBAL_STEP_COUNTER % bssn::BSSN_IO_OUTPUT_FREQ == 0)) {
        file.write((char *)a_rhs, sizeof(double) * n);
        file.write((char *)chi_rhs, sizeof(double) * n);
        file.write((char *)K_rhs, sizeof(double) * n);
        file.write((char *)gt_rhs00, sizeof(double) * n);
        file.write((char *)gt_rhs01, sizeof(double) * n);
        file.write((char *)gt_rhs02, sizeof(double) * n);
        file.write((char *)gt_rhs11, sizeof(double) * n);
        file.write((char *)gt_rhs12, sizeof(double) * n);
        file.write((char *)gt_rhs22, sizeof(double) * n);
        file.write((char *)b_rhs0, sizeof(double) * n);
        file.write((char *)b_rhs1, sizeof(double) * n);
        file.write((char *)b_rhs2, sizeof(double) * n);
        file.write((char *)At_rhs00, sizeof(double) * n);
        file.write((char *)At_rhs01, sizeof(double) * n);
        file.write((char *)At_rhs02, sizeof(double) * n);
        file.write((char *)At_rhs11, sizeof(double) * n);
        file.write((char *)At_rhs12, sizeof(double) * n);
        file.write((char *)At_rhs22, sizeof(double) * n);
        file.write((char *)Gt_rhs0, sizeof(double) * n);
        file.write((char *)Gt_rhs1, sizeof(double) * n);
        file.write((char *)Gt_rhs2, sizeof(double) * n);
        file.write((char *)B_rhs0, sizeof(double) * n);
        file.write((char *)B_rhs1, sizeof(double) * n);
        file.write((char *)B_rhs2, sizeof(double) * n);
