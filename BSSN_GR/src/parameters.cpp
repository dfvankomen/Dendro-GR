...
double BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT                = 0.0;
double BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT               = 0.0;
double BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT                = 0.0;
double BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT               = 0.0;
...
unsigned int BSSN_NUM_WEIGHT_1_SOB_REFINE_VARS = 0;
unsigned int BSSN_WEIGHT_1_SOB_REFINE_VARIABLE_INDICES[BSSN_NUM_VARS] = {};
unsigned int BSSN_NUM_WEIGHT_2_SOB_REFINE_VARS = 0;
unsigned int BSSN_WEIGHT_2_SOB_REFINE_VARIABLE_INDICES[BSSN_NUM_VARS] = {};
...
void readParamTOMLFile(const char* fName, MPI_Comm comm) {
    ...
    if (parFile.contains("BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT"))
        bssn::BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT =
            parFile["BSSN_WEIGHT_1_DERIV_FIRST_WEIGHT"].as_floating();
    if (parFile.contains("BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT"))
        bssn::BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT =
            parFile["BSSN_WEIGHT_1_DERIV_SECOND_WEIGHT"].as_floating();
    if (parFile.contains("BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT"))
        bssn::BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT =
            parFile["BSSN_WEIGHT_2_DERIV_FIRST_WEIGHT"].as_floating();
    if (parFile.contains("BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT"))
        bssn::BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT =
            parFile["BSSN_WEIGHT_2_DERIV_SECOND_WEIGHT"].as_floating();
    ...
    if (parFile.contains("BSSN_NUM_WEIGHT_1_SOB_REFINE_VARS"))
        bssn::BSSN_NUM_WEIGHT_1_SOB_REFINE_VARS =
            parFile["BSSN_NUM_WEIGHT_1_SOB_REFINE_VARS"].as_integer();

    if (parFile.contains("BSSN_WEIGHT_1_SOB_REFINE_VARIABLE_INDICES"))
        for (unsigned int i = 0; i < bssn::BSSN_NUM_WEIGHT_1_SOB_REFINE_VARS; i++)
            bssn::BSSN_WEIGHT_1_SOB_REFINE_VARIABLE_INDICES[i] =
                parFile["BSSN_WEIGHT_1_SOB_REFINE_VARIABLE_INDICES"][i].as_integer();

    if (parFile.contains("BSSN_NUM_WEIGHT_2_SOB_REFINE_VARS"))
        bssn::BSSN_NUM_WEIGHT_2_SOB_REFINE_VARS =
            parFile["BSSN_NUM_WEIGHT_2_SOB_REFINE_VARS"].as_integer();

    if (parFile.contains("BSSN_WEIGHT_2_SOB_REFINE_VARIABLE_INDICES"))
