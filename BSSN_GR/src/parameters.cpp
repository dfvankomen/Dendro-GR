...
void readParamTOMLFile(const char* fName, MPI_Comm comm) {
    ...
    if (parFile.contains("DENDRO_LOG_FILE")) {
        bssn::DENDRO_LOG_FILE = parFile["DENDRO_LOG_FILE"].as_string();
    }
    // append .log and a time stamp
    ...
    if (parFile.contains("DENDRO_LOG_CONSOLE_LEVEL")) {
        bssn::DENDRO_LOG_CONSOLE_LEVEL =
            parFile["DENDRO_LOG_CONSOLE_LEVEL"].as_integer();
    }
    if (parFile.contains("DENDRO_LOG_FILE_LEVEL")) {
        bssn::DENDRO_LOG_FILE_LEVEL =
            parFile["DENDRO_LOG_FILE_LEVEL"].as_integer();
    }
    if (parFile.contains("DENDRO_LOG_FORCE_FILE_FLUSH")) {
        bssn::DENDRO_LOG_FORCE_FILE_FLUSH =
            parFile["DENDRO_LOG_FORCE_FILE_FLUSH"].as_boolean();
    }
