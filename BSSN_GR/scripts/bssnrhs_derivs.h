...
// First derivatives for DampPsi
deriv_x(grad_0_DampPsi, DampPsi, hx, sz, bflag);
deriv_y(grad_1_DampPsi, DampPsi, hy, sz, bflag);
deriv_z(grad_2_DampPsi, DampPsi, hz, sz, bflag);

// First derivatives for DampPhi
deriv_x(grad_0_DampPhi, DampPhi, hx, sz, bflag);
deriv_y(grad_1_DampPhi, DampPhi, hy, sz, bflag);
deriv_z(grad_2_DampPhi, DampPhi, hz, sz, bflag);
